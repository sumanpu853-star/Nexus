...
test("maps project roles to permissions", () => {
  ...
  assert.equal(
    roleHasPermission(PROJECT_ROLES.EDITOR, PROJECT_PERMISSIONS.MANAGE_INTEGRATIONS),
    true
  );
  assert.equal(
    roleHasPermission(PROJECT_ROLES.EDITOR, PROJECT_PERMISSIONS.RUN_INTEGRATIONS),
    true
  );
  assert.equal(
    roleHasPermission(PROJECT_ROLES.VIEWER, PROJECT_PERMISSIONS.READ_INTEGRATIONS),
    true
  );
  assert.equal(
    roleHasPermission(PROJECT_ROLES.VIEWER, PROJECT_PERMISSIONS.RUN_INTEGRATIONS),
    false
  );
  assert.equal(
    roleHasPermission(PROJECT_ROLES.EDITOR, PROJECT_PERMISSIONS.MANAGE_DEPLOYMENTS),
    true
  );
  assert.equal(
    roleHasPermission(PROJECT_ROLES.VIEWER, PROJECT_PERMISSIONS.READ_DEPLOYMENTS),
    true
  );
  assert.equal(
    roleHasPermission(PROJECT_ROLES.VIEWER, PROJECT_PERMISSIONS.MANAGE_DEPLOYMENTS),
    false
  );
});
